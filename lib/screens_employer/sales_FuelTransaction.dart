...
class _FuelTransactionScreenState extends State<FuelTransactionScreen> {
  ...
  String baseUrl = 'http://192.168.0.122:3000';
  ...
  Widget _buildFuelButton(String fuelType, IconData icon) {
    return Card(
      ...
      child: InkWell(
        ...
        child: Container(
          padding: const EdgeInsets.all(10.0), // ลดขนาด padding
          ...
          child: Column(
            children: [
              ...
              GridView.count(
                ...
                childAspectRatio: 1.2, // ปรับอัตราส่วน
                mainAxisSpacing: 2,
                crossAxisSpacing: 2,
                children: [
